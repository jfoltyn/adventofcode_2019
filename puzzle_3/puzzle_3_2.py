...
input1 = INPUT_1_ACTUAL
input2 = INPUT_2_ACTUAL
...
def find_crossing(wire_1, wire_2):
    ...
    crossings = {}
    for pos in wire_1_positions:
        if wire_2_positions.get(pos):
            crossings[pos] = wire_1_positions[pos] + wire_2_positions[pos]
...
crossings = find_crossing([move for move in input1.split(',')], [move for move in input2.split(',')])
distances = [crossings[crossing] for crossing in crossings]
print(min(distances))
